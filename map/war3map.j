...
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffFFFF80赏金来了！|r")
...
call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,10.,"距离回合结束还有1分钟！")
...
call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,10.,"距离回合结束还有3分钟！")
...
call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,10.,"警告！距离回合结束还有5分钟！")
...
exitwhen i>11
endloop
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"模块 SP:GMR 发生严重故障。请报告此BUG！")
return Location(0.,0.)
endfunction
...
set mode_uai=fl
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00AI|r 已启用。单位将根据护甲类型选择目标。")
endfunction
function SetArtilleryStatus takes boolean fl returns nothing
set mode_na=not fl
if(fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00攻城|r 已启用。你可以建造攻击敌方建筑的结构。")
...
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无攻城|r 已选择。你不能建造攻击敌方建筑的结构。")
...
set mode_nafk=fl
if(not fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无AFK|r 模式已禁用。命令 -afk 已启用。")
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无AFK|r 已选择。命令 -afk 已禁用。")
endif
endfunction
function SetCoinsStatus takes nothing returns nothing
set mode_coins=1
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00金币|r 模式已选择。每40秒将刷新一枚金币。")
endfunction
function SetCCoinsStatus takes nothing returns nothing
set mode_coins=10
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00疯狂金币|r 已选择。每40秒将刷新十枚金币。")
endfunction
function SetDRStatus takes boolean fl returns nothing
set mode_dualraces=fl
if(not fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00双种族|r 模式已禁用。")
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00双种族|r 已选择。每个队伍中每个种族可以被选择多次。")
endif
endfunction
function SetURStatus takes boolean fl returns nothing
set mode_ur=fl
if(fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00独有种族|r 已选择。每个种族只能被选择一次（跨队伍也如此）。")
if((CountPlayersInForceBJ(leftPlayers)+CountPlayersInForceBJ(rightPlayers))+mode_bans*2>10)then
set mode_ur=false
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00独有种族|r 模式因玩家过多已禁用。")
endif
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00独有种族|r 模式已禁用。")
endif
endfunction
function SetTBStatus takes boolean fl returns nothing
set mode_tb=fl
if(fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无宝箱|r 模式已禁用。")
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无宝箱|r 已选择。你不能建造宝箱。")
endif
set bj_forLoopAIndex=0
set bj_forLoopAIndexEnd=11
loop
...
set mode_nb=fl
if(fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无赏金|r 模式已禁用。")
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无赏金|r 已选择。单位和建筑被摧毁时不会提供赏金。")
endif
set bj_forLoopAIndex=0
set bj_forLoopAIndexEnd=11
loop
...
set mode_sb=fl
if(fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无特殊建筑|r 模式已禁用。")
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无特殊建筑|r 已选择。除了防御塔和宝箱外，你不能建造特殊建筑。")
endif
set bj_forLoopAIndex=0
set bj_forLoopAIndexEnd=11
loop
...
set mode_ia=fl
if(fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无物品|r 模式已禁用。")
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无物品|r 已选择。城堡不出售任何物品。")
endif
endfunction
function SetLAStatus takes boolean fl returns nothing
set mode_la=fl
if(fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无传说|r 模式已禁用。")
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无传说|r 已选择。你不会获得购买传说建筑所需的人口。")
endif
endfunction
function SetRSEStatus takes boolean fl returns nothing
set mode_rse=fl
if(fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无毁灭打击|r 模式已禁用。")
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无毁灭打击|r 已选择。你的工人无法使用毁灭打击！")
endif
endfunction
function SetLLStatus takes integer val returns nothing
if(val<150)then
set mode_lumberLimit=-1
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00木材上限|r 模式已禁用。")
else
...
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00无税收|r 已选择。你无需为收入缴纳税款。")
elseif(mode_taxes==2)then
set Income_mTaxesValue=12.5
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00高税收|r 已选择。税率每12.5收入增加10%。")
endif
endfunction
function SetCCStatus takes boolean fl returns nothing
set mode_cc=fl
if(fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00笼斗|r 模式已禁用。")
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00笼斗|r 已选择。你可以用建筑困住单位。")
endif
endfunction
function SetDOMStatus takes boolean fl returns nothing
set mode_dom=fl
if(fl)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00统治|r 模式已选择。如果10个或更多单位围攻基地，阵营将失去收入（最多30%）。")
else
...
if(var==0)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00自动平衡|r 已设置为 |cffFFFF000|r。离开玩家的所有单位将分配给队伍中的其他成员。")
elseif(var==1)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00自动平衡|r 已设置为 |cffFFFF001|r。离开玩家的所有关联玩家将在队伍成员之间共享。")
else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00自动平衡|r 已设置为 |cffFFFF001|r。AI将接管任何离开的玩家。")
endif
endfunction
...
call LogAdd("增加收入："+I2S(pid)+" :"+GetUnitName(u)+" :"+R2S(iv))
if(ain==null)then
set ain=0.0
endif
...
call LogAdd("减少收入："+I2S(pid)+" :"+GetUnitName(u)+" :"+R2S(v))
endfunction
...
local integer id=GetPlayerId(p)
call DisplayTimedTextToPlayer(p,0.,0.,15.,"-------- 回合统计：--------")
...
if(mode_coins>0)then
call DisplayTimedTextToPlayer(p,0.,0.,15.,"收集金币：|cffFFFF00"+I2S(statisticCoins[id])+"|r (|cffFFFF00"+I2S(statisticCoinsGold[id])+"|r gold)")
endif
...
local integer i
local player p
call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,20.,"|cffFFFF80-----------  回合结束统计  -----------|r")
call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,20.,"回合时间："+GetGameTime())
call LogAdd("=== 回合结束 ===")
...
exitwhen i>11
endloop
call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,20.,"赚钱王："+s+" - |cffFFFF00"+I2S(g)+"|r (|cffFFFF00"+t+"|r gold in total)")
if(mode_coins>0)then
...
exitwhen i>11
endloop
call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,20.,"金币收集者："+s+" - |cffFFFF00"+I2S(statisticCoins[g])+"|r (|cffFFFF00"+t+"|r gold in total)")
endif
...
call TimerDialogSetTitle(DialogMainInit___td,"游戏开始：")
call TimerDialogDisplay(DialogMainInit___td,true)
call DisplayTimedTextToPlayer(Player(0),0.,0.,30.,"欢迎来到 |cffFFFF80城堡之战|r！你有20秒时间输入游戏模式。如果不输入有效命令，你将可以通过对话框选择游戏模式。查看|cff80FF00手册|r（|cffFFBA17F9|r）了解详情。")
...
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"时间到，并非所有玩家同意。额外回合被拒绝！")
endfunction
...
call TimerDialogDisplay(XRControl___timwin,false)
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"所有玩家已同意，回合数增加 "+I2S(XRControl___value))
set addingByXR=true
...
call TimerDialogDisplay(XRControl___timwin,false)
call TimerDialogSetTitle(XRControl___timwin,"投票 XR")
endfunction
...
call DisplayTextToPlayer(caller,0.,0.,"命令 [|c00ff0000Fill|r] 无法执行。配额玩家数量不足。")
return
endif
loop
...
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cff808080遇到已弃用的永久战争迷雾激活。已忽略。|r")
return
endif
set mode_fogtime=-1
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00永久战争迷雾|r 已选择")
return
endif
set mode_fogtime=t
...
set mode_fogtime=0
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00战争迷雾|r 已移除。全地图可见。")
endfunction
...
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00持续收入|r 已启用。")
...
set mode_gates=true
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00城堡大门|r 已启用。你可以控制城堡大门。")
...
call DisplayTimedTextToPlayer(cjlocgn_00000000,0.,0.,10.,"|cffFFFF00护甲表：")
call DisplayTimedTextToPlayer(cjlocgn_00000000,0.,0.,10.,"|cffFFCC00混乱伤害：|cffFFFF00对所有类型均为普通|r")
call DisplayTimedTextToPlayer(cjlocgn_00000000,0.,0.,10.,"|cffFFCC00普通伤害：|cff00FF00克制：|r中型 |cffFF0000被克制：|r轻型")
call DisplayTimedTextToPlayer(cjlocgn_00000000,0.,0.,10.,"|cffFFCC00穿刺伤害：|cff00FF00克制：|r轻型        |cffFF0000被克制：|r重型")
call DisplayTimedTextToPlayer(cjlocgn_00000000,0.,0.,10.,"|cffFFCC00魔法伤害：|cff00FF00克制：|r重型      |cffFF0000被克制：|r中型")
call DisplayTimedTextToPlayer(cjlocgn_00000000,0.,0.,10.,"|cffFFCC00攻城伤害：|cff00FF00克制：|r强化 |cffFF0000被克制：|r其他所有")
call DisplayTimedTextToPlayer(cjlocgn_00000000,0.,0.,10.,"|cffFFCC00注意：|r 除了混乱攻击，所有攻击类型对神圣护甲都是|cffFF0000较差|r的！")
...
call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,10.,"准备开始新回合...")
...
set wins[1]=wins[1]+1
call SetMBValue(5,2,I2S(wins[1]))
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cff00FF00东部军团|r赢得了本回合！")
if(wins[1]>=mode_rounds)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffFFFF00恭喜！|cff00FF00东部军团|r|cffFFFF00赢得了比赛！游戏将在一分钟后结束。|r")
...
set wins[0]=wins[0]+1
call SetMBValue(5,1,I2S(wins[0]))
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffFF0000西部军团|r赢得了本回合！")
if(wins[0]>=mode_rounds)then
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffFFFF00恭喜！|cffFF0000西部军团|r|cffFFFF00赢得了比赛！游戏将在一分钟后结束。|r")
...
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffFFAC00所有玩家已投票平局，回合将重新开始！|r")
call EndRoundScenario___FinalizeRound()
endfunction
...
call TimerDialogSetTitle(pickTimerWindow,"禁用时间：")
...
set pickTime=CreateTimer()
set pickTimerWindow=CreateTimerDialog(pickTime)
call TimerDialogSetTitle(pickTimerWindow,"选择时间：")
call TimerDialogDisplay(pickTimerWindow,true)
...
set EndRoundScenario_victory=1
set IsGameEnding=true
call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,60.,"|cffFF0000西部军团|r所有玩家已离开。|cff00FF00东部军团|r获胜！")
call ForForce(leftPlayers,function Defeat)
call ForForce(rightPlayers,function Victory)
return
endif
...
set EndRoundScenario_victory=2
set IsGameEnding=true
call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,60.,"|cff00FF00东部军团|r所有玩家已离开。|cffFF0000西部军团|r获胜！")
call ForForce(leftPlayers,function Victory)
call ForForce(rightPlayers,function Defeat)
return
endif
...
call DisplayTextToPlayer(p,0.,0.,"|cffFF0000你无法增加传说建筑上限！无传说模式已激活！|r")
endif
...
call DisplayTextToPlayer(cjlocgn_00000000,0.,0.,"|cffFF0000你的工人不能离开城堡！|r")
endif
if(mode_cc)then
